...
enum EFFECT_SKILL_OPTION : std::int32_t {
    EFFECT_SKILL_OPTION_NONE = 0,
    EFFECT_SKILL_OPTION_DAMAGE = 1,
    EFFECT_SKILL_OPTION_COOLTIME = 2,
    EFFECT_SKILL_OPTION_SUPER_ARMOR = 3,
    EFFECT_SKILL_OPTION_SG = 4,
    EFFECT_SKILL_OPTION_PER_DAMAGE = 5,
    EFFECT_SKILL_OPTION_MAX = 6,
};
